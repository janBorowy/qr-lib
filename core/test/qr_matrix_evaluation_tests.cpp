...
const MutableQrCode
    SECOND_RULE_SAMPLE_MATRIX({W, B, B, B, B, B, W, B, B, W, B, B,  // 1
...
const MutableQrCode THIRD_RULE_SAMPLE_MATRIX(
    {
...
const MutableQrCode SAMPLE_MATRIX(
    {
